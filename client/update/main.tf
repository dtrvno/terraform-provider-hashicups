...
provider "orch" {
  ...
  resource "orch_iaas_provider_update_resource" "my_iaas_update" {
      guid_id=orch_iaas_provider_resource.my_iaas.guid_id
      type=var.iaas_type
      name=var.iaas_name
 ...
 output "my_iaas_output" {
  value=[orch_iaas_provider_update_resource.my_iaas_update.guid_id,orch_iaas_provider_update_resource.my_iaas_update.url]
}
